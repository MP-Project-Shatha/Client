  ...
  return (
    <>
      ...
      <section className={"welcome-section"}>
        <div className="welcome-screen">
          <div className="welcome-text">
            <p>
              start <span>exercising</span> today
            </p>
          </div>
        </div>
        <video
      ...
      <section className="top-exercises">
        ...
        <h1 className={"section-title"}>Top Workout in Hero Gym</h1>
        <div className="cards-container">
          <div className="card">
            ...
            <h2 className="card-title">Chest Workout</h2>
            <p className="card-desc">
              Chest Exercises Will Make Your Body Shape And Train Breathing And
              Make Blood Circulation Smooth
            </p>
          ...
          <div className="card active">
            ...
            <h2 className="card-title">Leg Workout</h2>
            <p className="card-desc">
          ...
          <div className="card">
            ...
            <h2 className="card-title">Belly Workout</h2>
            <p className="card-desc">
              Abdominal Exercises Will Make Your Body Look Like A Bodybuilder
              And Big And Will Make You A Girl
            </p>
